...
public class Questions {
	...
	private QuestionObject wifi = new QuestionObject(3, R.string.wifi, R.drawable.ic_wifi, R.color.orange, "wifi", "yes", "no", "");
	private QuestionObject wifi_fee = new QuestionObject(4, R.string.wifi_fee, R.drawable.ic_wifi, R.color.orange, "wifi:fee", "yes", "no", "");
