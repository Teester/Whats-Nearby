...
public class Questions {
	...
	private QuestionObject cash = new QuestionObject(13, R.string.cash, R.drawable.ic_money, R.color.green, "payment:cash", "yes", "no", "");
	private QuestionObject cheques = new QuestionObject(14, R.string.cheques, R.drawable.ic_check, R.color.green, "payment:cheque", "yes", "no", "");
	private QuestionObject contactless = new QuestionObject(17, R.string.contactless, R.drawable.ic_credit_card, R.color.green, "payment:contactless", "yes", "no", "");
	private QuestionObject credit_card = new QuestionObject(15, R.string.credit_card, R.drawable.ic_credit_card, R.color.green, "payment:credit_cards", "yes", "no", "");
	private QuestionObject debit_card = new QuestionObject(16, R.string.debit_card, R.drawable.ic_credit_card, R.color.green, "payment:debit_cards", "yes", "no", "");
	private QuestionObject deliver = new QuestionObject(11, R.string.deliver, R.drawable.ic_delivery_man, R.color.purple, "delivery", "yes", "no", "");
	private QuestionObject dispensing = new QuestionObject(18, R.string.dispensing, R.drawable.ic_drugs, R.color.cyan, "dispensing", "yes", "no", "");
	private QuestionObject drive_through = new QuestionObject(9, R.string.drive_through, R.drawable.ic_drive_through, R.color.purple, "drive_through", "yes", "no", "");
	...
	private QuestionObject organic = new QuestionObject(7, R.string.organic, R.drawable.ic_carrot, R.color.red, "organic", "yes", "no", "");
	private QuestionObject outdoor_seating = new QuestionObject(2, R.string.outdoor_seating, R.drawable.ic_outdoor_cafe, R.color.red, "outdoor_seating", "yes", "no", "");
	private QuestionObject reservation = new QuestionObject(12, R.string.reservation, R.drawable.ic_reserved, R.color.purple, "reservation", "yes", "no", "");
	private QuestionObject takeaway = new QuestionObject(10, R.string.takeaway, R.drawable.ic_takeaway, R.color.purple, "takeaway", "yes", "no", "");
	private QuestionObject vegan = new QuestionObject(6, R.string.vegan, R.drawable.ic_carrot, R.color.blue, "diet:vegan", "yes", "no", "");
	private QuestionObject vegetarian = new QuestionObject(5, R.string.vegetarian, R.drawable.ic_carrot, R.color.blue, "diet:vegetarian", "yes", "no", "");
