...
public class Dispensing implements QuestionsContract {
	private int id = 14;
	private int question = R.string.dispensing;
	private int drawable = R.drawable.ic_unsure;
	private int color = R.color.cyan;
	private String tag = "dispensing";
